...
const INSTRUCTIONS = [
  ...
  'Страница kind=jam — свободная доска: стикеры, фигуры, текст, рисунки и коннекторы. ' +
    'Её объекты лежат В САМОЙ странице и на других страницах не видны — в отличие от узлов. ' +
    'get_board отдаёт только их число (jam_items) и разбивку по видам, сами объекты — ' +
    'jam_read. Класть и править: jam_add, jam_update, jam_delete, раскладывать — jam_arrange.',
  'Коннектор на доске — это ЛИНИЯ, а не зависимость: он не влияет на слои, вес узла ' +
    'и критический путь. Зависимость между узлами создаётся только link_nodes.',
